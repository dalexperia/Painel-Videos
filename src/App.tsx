import React, { useState } from 'react';
    ...
    import { Video, Clapperboard, Trash2, Youtube, Calendar, BarChart2, Settings as SettingsIcon } from 'lucide-react';

    type View = 'dashboard' | 'gallery' | 'reproved' | 'posted' | 'scheduled' | 'settings';
            ...
            <div className="container mx-auto px-4 max-w-7xl">
              <div className="flex items-center justify-between h-16">
                ...
                <nav className="flex items-center gap-1 sm:gap-2">
                  ...
                  <NavButton activeView={view} targetView="gallery" onClick={() => setView('gallery')}>
                    <Video size={18} />
